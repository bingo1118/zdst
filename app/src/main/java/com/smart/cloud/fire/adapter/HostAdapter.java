...
public class HostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Repeater> listNormalSmoke;

    public HostAdapter(Context mContext, List<Repeater> listNormalSmoke) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            switch (normalSmoke.getHoststate()){
                case 0:
    ...
    //添加数据
    public void addItem(List<Repeater> smokeList) {
    ...
    public void addMoreItem(List<Repeater> smokeList) {
        listNormalSmoke.addAll(smokeList);
        notifyDataSetChanged();
    }
