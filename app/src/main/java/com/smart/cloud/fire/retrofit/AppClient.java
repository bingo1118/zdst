...
public class AppClient {
    ...
    public static Retrofit retrofit(String url) {
        ...
        if (mRetrofit == null) {
            ...
            mRetrofit = new Retrofit.Builder()
                    .baseUrl(url)
                    .addConverterFactory(ArbitraryResponseBodyConverterFactory.create("GB2312"))
     ...
     * @return
     */
    public static Retrofit retrofit(String url,String encode) {
        if(mRetrofit!=null){
            mRetrofit=null;
        }
        if (mRetrofit == null) {
            ...
            mRetrofit = new Retrofit.Builder()
                    .baseUrl(url)
                    .addConverterFactory(ArbitraryResponseBodyConverterFactory.create(encode))
                    .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                    .client(okHttpClient)
                    .build();
        }
