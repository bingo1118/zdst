...
public class MainActivity extends MvpActivity<MainPresenter> implements MainView {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("APP_EXIT")) {
                SharedPreferencesManager.getInstance().putData(mContext,
                        ...
                        "");
                PushManager.getInstance().stopService(getApplicationContext());//结束推送。。
                unbindAlias();
    ...
    private void unbindAlias() {
        ...
        String url= ConstantValues.SERVER_IP_NEW+"loginOut?userId="+username+"&alias="+username+"&cid="+userCID;
