...
public class AirInfoActivity extends Activity {
    ...
    private String getQuality(int priority) {
        ...
        switch (priority){
            case 1:
                quality="优";
                linearLayout.setBackgroundColor(android.graphics.Color.parseColor("#2dac5a"));
                break;
            case 2:
                quality="良";
                linearLayout.setBackgroundColor(android.graphics.Color.parseColor("#4278d0"));
                break;
            case 3:
                quality="中";
                linearLayout.setBackgroundColor(android.graphics.Color.parseColor("#e7863f"));
                break;
            case 4:
                quality="差";
                linearLayout.setBackgroundColor(android.graphics.Color.parseColor("#dd5c3e"));
                break;
        }
        return quality;
    }
